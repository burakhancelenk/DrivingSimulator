...
public class WrldMap : MonoBehaviour
{
    ...
    [SerializeField]
    public bool m_useBuiltInCameraControls = true;
    public static bool isCameraControlsEnabled = true;
    ...
    public void SetDefaultCameraConf()
    {
        m_distanceToInterest = 1781.0;
        m_headingDegrees = 0.0;
    }

    public void ReinitializeApiInstance()
    {
        m_api.Destroy();
